...
dbg:
	...
	python -m pdb main.py --early_stop 0 --stop_batch_num 1 --sel_model double --batch_size 2 --invar_path ./datasets/invar_data/synthetic_two --enable_perm 1 --num_iterations 500 --perm_num 2
