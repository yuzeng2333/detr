...
class InvarHungarianMatcher(nn.Module):
    ...
    def __init__(self, cost_eq: float = 1, cost_op: float = 1):
        """Creates the matcher
...
def build_matcher(args):
    return InvarHungarianMatcher(cost_class=args.set_cost_class, cost_bbox=args.set_cost_bbox, cost_giou=args.set_cost_giou)
